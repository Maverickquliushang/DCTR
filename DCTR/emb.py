...
def main(args):
    ...
    train_set = load_dataset('/mnt/hdd1/allusers/Maverick/SubgraphRAG-main/data/webqsp', split='train')
    val_set = load_dataset('/mnt/hdd1/allusers/Maverick/SubgraphRAG-main/data/webqsp', split='validation')
    test_set = load_dataset('/mnt/hdd1/allusers/Maverick/SubgraphRAG-main/data/webqsp', split='test')
