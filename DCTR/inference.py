...
def main(args):
    ...
    for i in tqdm(range(len(infer_set))):
        ...
        h_id_tensor, r_id_tensor, t_id_tensor, q_emb, entity_embs, \
            ...
            target_triple_probs, a_entity_id_list, triple_scores_flow = prepare_sample(device, sample)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path', type=str,
                        default=r"E:\github\SubgraphRAG\SubgraphRAG-main\retrieve\webqsp_loss_1\cpt.pth",
                        help='Path to a saved model checkpoint, e.g., webqsp_Nov08-01:14:47/cpt.pth')
